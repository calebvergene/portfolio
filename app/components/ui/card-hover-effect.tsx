        ...
        {(link || github) && (
          <div className="mt-auto px-8 pb-8 flex space-x-4">
            {link && (
              ...
              rel="noopener noreferrer" className="bg-emerald-600 text-white px-4 py-2 mt-6 rounded-lg hover:bg-emerald-700 duration-300">
                Visit
              </Link>
            )}
            {github && (
              <Link href={github} target="_blank" 
              rel="noopener noreferrer" className="bg-white/[0.2] text-white px-1.5 py-1 mt-6 rounded-lg">
